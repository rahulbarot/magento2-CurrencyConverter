...
namespace DevAwesome\CurrencyConverter\Model\Currency\Import;
 ...
 */
class CurrencyApiConverter extends \Magento\Directory\Model\Currency\Import\AbstractImport
{
    /**
     * @var string
     */
    public const CURRENCY_CONVERTER_URL =
    'https://api.currencyapi.com/v3/latest?apikey={{ACCESS_KEY}}&base_currency={{BASE_CURRENCY}}';
